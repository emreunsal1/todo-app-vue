<template>
  <div class="todo">
    ...
    <div class="todo__right">
      <img class="todo__right__delete" src="../../assets/Delete.svg" @click="deleteTodo(todo._id)" />
      <Select :options="selectOptions" @change="updatePriority" :default-value="todo.priority" />
    </div>
...
export default {
  name: "ListItem.vue",
  components: {Select, Priority, TodoContent},
  data(){
    return {
      isSelectOpened: false,
      selectOptions: [{ text: "Low", value: "low", icon: "low" },
